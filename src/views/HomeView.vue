                ...
                <v-row justify="center" class="space">
                  ...
                  >
                    <v-item v-slot="{ isSelected, toggle }">
                      <v-card
                        :color="isSelected ? '#D5F0DB' : 'white'"
                        :class="isSelected ? 'borderme' : 'borderout'"
                            ...
                            <v-list-item three-line class="text-center">
                              <v-list-item-content>
                                ...
                                <v-list-item-subtitle
                                  :class="
                                    isSelected ? 'green--text' : 'black--text'
                                  "
                                  class="caption mt-4"
...
const chair = true,
  ...
  slider2 = 50,
  categories = [
    { img: "9.png", title: i18n.t("menu.sleepingBeds") },
    { img: "2.png", title: i18n.t("menu.loungeChairs") },
    { img: "1.png", title: i18n.t("menu.chairs") },
    { img: "4.png", title: i18n.t("menu.officeChairs") },
    { img: "8.jpg", title: i18n.t("menu.tablesNightstands") },
    { img: "6.png", title: i18n.t("menu.kitchenFurniture") },
  ],
  chairs = [
    {
      class: "pa-0",
